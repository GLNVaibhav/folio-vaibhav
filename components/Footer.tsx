    ...
    <footer className="bg-background border-t border-border py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
          className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 pb-8 border-b border-border"
        >
          {/* Brand */}
          <div>
            <h3 className="text-xl font-bold text-primary mb-2">Vaibhav Gollamudi</h3>
            <p className="text-foreground/60 text-sm">
              Full-Stack Developer | ML Enthusiast | Building intelligent systems
            </p>
          </div>
        ...
        >
          <p>&copy; {currentYear} Vaibhav Gollamudi. All rights reserved.</p>
